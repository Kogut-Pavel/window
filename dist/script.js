...
var changeModalState = function changeModalState(state) {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["checkNumInputs"])('#width');
  Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["checkNumInputs"])('#height');
...
var forms = function forms(state) {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["checkNumInputs"])('input[name="user_phone"]');
  var message = {
    // Объект со статусами
    loading: 'Загрузка...',
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (event) {
      event.preventDefault(); // Создаем блок для оповещения пользователя о статусе
      ...
      postData('assets/server.php', formData).then(function () {
        ...
        Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["clearInputs"])();
        Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["clearState"])(state);
        setTimeout(function () {
          Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["closeModals"])();
...
var images = function images() {
  ...
  var scroll = Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["calcScroll"])();
  ...
  workSection.addEventListener('click', function (event) {
    ...
    if (target && target.classList.contains('preview')) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["modifyBody"])('hidden', scroll);
    }

    if (target && target.matches('div.popup')) {
      imgPopup.style.display = 'none';
      Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["modifyBody"])('', 0);
    }
  });
};
...
var modals = function modals(state) {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var scroll = Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["calcScroll"])();
    trigger.forEach(function (item) {
      item.addEventListener('click', function (event) {
        ...
        Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["closeModals"])();
        modal.style.display = "block";
        Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["modifyBody"])('hidden', scroll);
      });
    });
    close.addEventListener('click', function () {
      Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["closeModals"])();
      Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["clearState"])(state);
      Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["clearInputs"])();
      Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["modifyBody"])('', 0);
    });
...
/*!*************************************!*\
  !*** ./src/js/services/services.js ***!
  \*************************************/
/*! exports provided: calcScroll, modifyBody, checkNumInputs, clearInputs, closeModals, clearState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); // Всем инпутам с вводом телефона разрешаем только цифры
